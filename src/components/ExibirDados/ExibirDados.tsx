...
const ExibirDados = () => {
    ...
    async function findAll() {
        try {
            const responseReceita = await axios.get(
                'http://backend-financas-production.up.railway.app/receitas',
            );
            setReceitas(responseReceita.data);

            const responseDespesas = await axios.get(
                'http://backend-financas-production.up.railway.app/despesas',
            );
    ...
    async function Deletes(id: number) {
        await axios.delete(
            `http://backend-financas-production.up.railway.app/${id}`,
        );
        await axios.delete(
            `http://backend-financas-production.up.railway.app/${id}`,
        );
