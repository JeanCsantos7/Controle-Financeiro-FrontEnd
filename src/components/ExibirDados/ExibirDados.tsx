    ...
    async function findAll() {
        try {
            const responseReceita = await axios.get(
                'https://controle-financeiro-back-pt4rurdhe-jeancsantos7s-projects.vercel.appreceitas',
            );
            setReceitas(responseReceita.data);

            const responseDespesas = await axios.get(
                'https://controle-financeiro-back-pt4rurdhe-jeancsantos7s-projects.vercel.appdespesas',
            );
