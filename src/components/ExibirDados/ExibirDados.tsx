...
const ExibirDados = () => {
    ...
    async function findAll() {
        try {
            const responseReceita = await axios.get(
                'https://controle-financeiro-back-da8ip8umc-jeancsantos7s-projects.vercel.app/receitas',
            );
            setReceitas(responseReceita.data);

            const responseDespesas = await axios.get(
                'https://controle-financeiro-back-da8ip8umc-jeancsantos7s-projects.vercel.app/despesas',
            );
    ...
    async function Deletes(id: number) {
        await axios.delete(
            `https://controle-financeiro-back-da8ip8umc-jeancsantos7s-projects.vercel.app/${id}`,
        );
        await axios.delete(
            `https://controle-financeiro-back-da8ip8umc-jeancsantos7s-projects.vercel.app/${id}`,
        );
